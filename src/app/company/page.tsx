...
const PROFILE = [
  ...
  { dt: "事業内容", dd: ["アパレル製品の企画、製造販売、デザイン及びコンサルタント業務、デザインの制作", "SNSマーケティング×インフルエンサーマッチング支援", "ホームページ制作、デザインの制作", "海外向けEC販売事業、アウトソーシング事業", "アーティストの活動支援"] },
  { dt: "資本金", dd: ["3,000,000円"] },
];
const HISTORY = [
  { dt: "2025.04", dd: "東京・渋谷にて株式会社MasKOFFを設立" },
  { dt: "2025.08", dd: "MasKOFFメンバー20名突破" },
  { dt: "2025.11", dd: "オリジナルファッションブランド DotHyphenを発表" },
    ...
    <>
      ...
      <section className="wrap section-pad">
        ...
        <p data-reveal="up" style={rd(1)} className="mt-8 max-w-[640px] text-body leading-[2.1] text-fg-body">
          MASK OFFには「仮面を外す」「素の自分」という意味があります。誰もが空気を読み、誰かの正解をなぞるこの時代に、自分だけの感性をさらけ出すこと。
          株式会社MasKOFFは、進化したこの時代で新たな個性をさらけ出すという理念のもと、オリジナルファッションブランドの企画・デザインを軸に、クリエイティブサービスを提供しています。
        </p>
      </section>
