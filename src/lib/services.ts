...
export type Service = {
  ...
  /** SERVICE 一覧の本文・詳細ページの構造化データ用。"\n" を入れるとその位置で改行する（whitespace-pre-line。構造化データでは空白に置換） */
  description: string;
  /** タグチップ（3 つ） */
...
export const SERVICES: readonly Service[] = [
  {
    ...
    description:
      `未経験からエンジニアを目指す実践型カリキュラム「${SITE.product}」を運営 \n実案件ベースの課題と現役エンジニアのメンタリングで、現場で通用するスキルを育てます。`,
  ...
  },
  {
    ...
    description:
      "業務システムからサービス立ち上げまで、企画・UI/UX設計・開発・運用を一貫して提供\n小さく速くリリースし、改善を重ねる開発スタイルで事業の成長に伴走します。",
  ...
  },
  {
    ...
    title: "SNSマーケティング事業",
    verb: "魅せる",
    lead: "-イメージ”を崩さないSNSマーケティング- \n企業様向けに弊社で磨き上げた優秀なスタッフをBPOを通して支援いたします。\n各企業の課題ヒアリングから設計、テスト、運用実施後、\nお客様のタイミングに合わせて即時解決いたします。",
    description:
  ...
  },
  {
    ...
    verb: "纏う",
    lead: "ブランドを立ち上げたい個人または企業向けにデザインの作成からメーカーの取次、販売戦略まで\nトレンドに合わせた支援が出来ます。\n広告運用からインフルエンサーの起用も可能",
    description:
      "オリジナルブランド運営で培った知見をもとに、ブランド立ち上げ・OEM/ODM・販売戦略を支援\nコンセプト設計からものづくり、売り場づくりまで伴走します。",
  ...
  },
  {
    ...
    verb: "支える",
    lead: "アナタの”MIRAIZU”を形成します。\nキャリア面談・スキル向上研修を通して、\n一人ひとりの「らしさ」を活かした働き方を提供します。",
    description:
      `キャリア面談・研修を通じて、一人ひとりの「らしさ」を活かした働き方を支援\n ${SITE.product}修了生のキャリアサポートとも連動しています。`,
    tags: ["キャリア面談・スキル向上研修"],
  ...
  },
  {
    ...
    title: "求人広告代理店事業",
    verb: "募る",
    lead: "媒体選定から原稿制作、掲載後の運用改善まで、\n採用広告をワンストップで支援します。",
    description:
      "各種求人媒体の正規代理店として、媒体選定から原稿制作、掲載後の運用改善までをワンストップで支援\n 採用ターゲットに届く広告設計で、企業の採用力を高めます。",
    tags: ["媒体選定", "原稿制作", "運用改善"],
  ...
  },
  {
    ...
    description:
      "海外マーケットプレイスへの出店から、物流・決済・多言語対応まで、越境ECの立ち上げと運用を支援\n 日本の商品を世界の顧客へ届けます。",
  ...
  },
  {
    ...
    description:
      "中小企業のITツール選定・導入・定着をサポート\n 補助金の活用支援も含め、現場に無理なく根づくDXを、伴走型で実現します。",
