...
export const PARTNERS: readonly Partner[] = [
  ...
  { id: "p2", tag: "PARTNERSHIP", name: "インターベル事業提携", text: "互いの強みを掛け合わせる事業提携パートナー。サービスの企画から営業・運営までを共同で推進し、事業領域を広げる。", image: "/images/partners/p02.jpg", icon: "/images/partners/icon-02.png" },
  ...
  { id: "p4", tag: "DROPSHIPPING", name: "ドロップシッピング事業", text: "在庫を持たずに商品を販売するEC事業。商品選定からストア構築、受注・配送手配までを一貫して運営。", image: "/images/partners/p04.jpg", icon: "/images/partners/icon-04.png" },
];
