...
// 1 行目のテキストセルは 2026-09-17 に角丸ひし形の人物写真 hero-16（2/3 配置）に差し替え。3 行目のテキストセルは残す
...
const GLITCH = { type: "video" as const, src: "/videos/hero/hero-01.mp4", poster: "/images/hero/hero-01-poster.webp", size: 4 / 9 };
